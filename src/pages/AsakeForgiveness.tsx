...
function StatCard({ number, label }: { number: string; label: string }) {
  return (
    <div
      style={{
        border: "1px solid rgba(200,150,14,0.2)",
        borderRadius: 16,
        padding: "24px 28px",
        textAlign: "center",
    ...
    >
      ...
      <div
        style={{
          ...
          background: hovered
            ? "rgba(3,3,3,0.65)"
            : "linear-gradient(to top, rgba(3,3,3,0.92) 0%, rgba(3,3,3,0.1) 60%)",
        ...
        {hovered && (
          <div
            style={{
              ...
              background: "rgba(200,150,14,0.9)",
              borderRadius: "50%",
              width: 42,
              height: 42,
              display: "flex",
              alignItems: "center",
              justifyContent: "center",
              boxShadow: "0 0 20px rgba(200,150,14,0.5)",
            }}
          >
...
const GLOBAL_STYLES = `
  ...
  .asake-divider {
    height: 1px;
    background: linear-gradient(to right, transparent, rgba(200,150,14,0.5), transparent);
  }
  .asake-platform-btn {
    display: inline-flex;
    align-items: center;
    ...
    >
      ...
      >
        ...
        >
          ...
          <div
            style={{
              ...
              inset: 0,
              background:
                "linear-gradient(180deg, rgba(3,3,3,0.72) 0%, rgba(3,3,3,0.28) 35%, rgba(3,3,3,0.78) 75%, rgba(3,3,3,1) 100%)",
            }}
          />
          {/* Gold light bloom from center */}
          <div
            style={{
              position: "absolute",
              inset: 0,
              background:
                "radial-gradient(ellipse 65% 45% at 50% 55%, rgba(200,150,14,0.22) 0%, rgba(200,150,14,0.06) 50%, transparent 75%)",
            }}
          />
        </motion.div>
        ...
        <div
          style={{
            ...
            filter: "blur(80px)",
            animation: "asake-pulse 6s ease-in-out infinite",
            pointerEvents: "none",
          }}
        />
        <div
          style={{
            ...
            height: 250,
            borderRadius: "50%",
            background: "rgba(200,150,14,0.05)",
            filter: "blur(70px)",
            animation: "asake-pulse 8s ease-in-out infinite 2s",
            pointerEvents: "none",
          }}
        />
        ...
        >
          ...
          <motion.h1
            ...
            style={{
              fontSize: "clamp(3.8rem, 17vw, 13rem)",
              fontWeight: 900,
              lineHeight: 0.88,
              textTransform: "uppercase",
              letterSpacing: "-0.02em",
          ...
          >
            FROM THE ALBUM{" "}
            <span style={{ color: "#C8960E" }}>M$NEY</span> · APRIL 30, 2026
          </motion.p>
          ...
          >
            <motion.a
              href="#video"
              whileHover={{ scale: 1.05, boxShadow: "0 0 30px rgba(200,150,14,0.45)" }}
              whileTap={{ scale: 0.97 }}
              style={{
                display: "inline-flex",
                alignItems: "center",
        ...
        <FadeIn>
          ...
          <div style={{ textAlign: "center", marginBottom: 36 }}>
            <span
              style={{
                ...
                border: "1px solid rgba(200,150,14,0.28)",
                borderRadius: 9999,
                padding: "6px 18px",
              }}
            >
          ...
          <div
            style={{
              ...
              border: "1px solid rgba(200,150,14,0.2)",
              boxShadow:
                "0 0 0 1px rgba(200,150,14,0.1), 0 0 80px rgba(200,150,14,0.12), 0 50px 100px rgba(0,0,0,0.7)",
              aspectRatio: "16/9",
              background: "#0A0A09",
            }}
          >
          ...
          >
            Produced by{" "}
            <span style={{ color: "#C8960E" }}>Magicsticks</span> &amp;{" "}
            <span style={{ color: "#C8960E" }}>Nana Ntorinkansah</span>
      ...
      >
        <FadeIn>
          ...
          >
            "A spiritual prayer — asking God for forgiveness while
            <br />
          ...
          >
            {["Street-pop", "Afrobeats", "Fuji", "Amapiano", "M$NEY · 2026"].map(
              (tag) => (
                <span
                  key={tag}
                  style={{
      ...
      <section
        ...
        style={{
          padding: "clamp(70px,9vw,130px) clamp(16px,4vw,48px)",
          textAlign: "center",
          background: "linear-gradient(180deg, transparent 0%, rgba(200,150,14,0.04) 40%, transparent 100%)",
        }}
      >
        <FadeIn>
          <p
      ...
      <footer
        style={{
          borderTop: "1px solid rgba(200,150,14,0.12)",
      ...
      >
        ...
        >
          Presented by{" "}
          <span style={{ color: "rgba(200,150,14,0.5)" }}>Ngoma Charts</span>
        </p>
      </footer>
    </div>
  );
